...
xgettext -kgettext -kN_ --c++ --from-code utf-8  -o translations/songrec.pot src/*.rs src/audio_controllers/*.rs src/core/*.rs src/fingerprinting/*.rs src/gui/*.rs src/utils/*.rs translations/interface.ui.h
