...
xgettext -kgettext -kN_ --c++ --from-code utf-8  -o translations/songrec.pot src/*.rs src/core/audio_controllers/*.rs src/core/*.rs src/core/fingerprinting/*.rs src/gui/*.rs src/plugins/*.rs src/utils/*.rs translations/interface.ui.h
